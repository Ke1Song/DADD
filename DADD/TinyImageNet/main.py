...
parser = argparse.ArgumentParser(description='Class Incremental Learning via Dual Augmentation and Dual Distillation')
...
parser.add_argument('--task_num', default=20, type=int, help='the number of incremental steps')
